...
public class AlcoholTest {
	...
	public void setUp() throws Exception {
		a1 = new  Alcohol ("A1Name", SIZE.size.SMALL, false );
		a2 = new  Alcohol ("A2NAme", SIZE.size.MEDIUM, true );
		a3 = new  Alcohol ("A3NAme", SIZE.size.LARGE, false );
		a4 = new  Alcohol ("A4NAme", SIZE.size.SMALL, true );
	...
	public void testToString() {
		...
		assertTrue(a1.toString().contains(a1.getBeverageSize().toString() ));
