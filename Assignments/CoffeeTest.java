...
public class CoffeeTest {
	...
	public void setUp() throws Exception {
		c1 = new  Coffee ("c1Name", SIZE.size.SMALL, false,false );
		c2 = new  Coffee ("c2NAme", SIZE.size.MEDIUM, true,true );
		c3 = new  Coffee ("c3NAme", SIZE.size.LARGE, false, true );
		c4 = new  Coffee ("c4NAme", SIZE.size.SMALL, true, false );
	...
	public void testToString() {
		...
		assertTrue(c1.toString().contains(c1.getBeverageSize().toString() ));
